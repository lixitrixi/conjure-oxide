...
///
/// The global metadata may be mutated as a side-effect of applying a rule, using the `mut_meta` method
/// of the passed [`Commands`] instance.
///
/// # Provided Implementations
/// This trait is automatically implemented by all types which implement
/// `Fn(&mut Commands<T, M>, &T, &M) -> Option<T>` for types `T: Uniplate` and `M`. This allows function
/// pointers and closures with the correct signatures to be used as rules directly.
///
/// # Example
/// ```rust
...
/// [`Rule`], to allow these to be passed directly to the engine instead of defining a custom type.
///
